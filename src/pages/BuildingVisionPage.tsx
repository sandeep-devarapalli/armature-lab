      ...
      >
        <div className="building-vision-principles">
          <article>
            ...
            <h3>Polished marble and selective LVT</h3>
            <p>Repair and polish existing marble where present; use warm oak or soft grey LVT only in rooms that need a new finish.</p>
          </article>
          <article>
